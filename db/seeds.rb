...
@pizza = Recipe.create(name: "Pizza", instructions: "Preheat oven to 500°. Let dough sit, covered, at room temperature 30 minutes. Meanwhile, process Parmesan, ricotta, cream, garlic, salt, pepper, ¾ cup corn, and 2 Tbsp. oil in a food processor until mostly smooth (mixture will still have some texture). Scrape creamed corn into a small bowl; stir in ¼ cup corn. Coat bottom and sides of a 13x9 rimmed baking sheet or baking dish with 2 Tbsp. oil. Place dough in center of baking sheet; gently press and stretch until it reaches to edges and into corners. (If dough springs back, let it rest a few minutes before continuing.) Spread creamed corn over dough, leaving a ½ border. Top with pepperoni, then tomatoes and remaining ½ cup corn. Bake until crust is golden underneath and cooked through, about 20 minutes. Top with smoked mozzarella and bake until cheese is melted, about 2 minutes. Drizzle with oil and top with basil leaves. Do ahead: Creamed corn mixture can be made 4 hours ahead. Cover and chill.", details: "Put the sauce, the mozzarela and tada")
...
@chocolate_cake = Recipe.create(name: "Chocolate cake", instructions: "Heat milk and chocolate in a small saucepan over medium-low, whisking often, until chocolate is melted and mixture is smooth. Cover and chill. Do Ahead: Soak can be made 3 days ahead. Keep chilled. Place ½ cup cold water in a small bowl and sprinkle gelatin evenly over top; chill until ready to use. Place chocolate and salt in a large wide bowl. Heat milk and corn syrup in a small saucepan over medium, whisking to combine, until steaming and barely simmering around the edges of pan. Remove from heat and add softened gelatin, whisking until dissolved. Reheat milk mixture briefly over medium-low (do not let it boil), then pour over chocolate mixture and let sit 1 minute. Gently whisk until smooth; reserve saucepan. Heat cream in reserved saucepan over medium just until warm to the touch, about 1 minute. Gradually stream cream into chocolate mixture, whisking constantly until incorporated and smooth. You should have around 4 cups ganache. Cover and chill until set, at least 4 hours. Do Ahead: Ganache can be made 3 days ahead. Keep chilled.", details: "Everybody likes chocolate cake")
@brownies = Recipe.create(name: "Brownies", instructions: "Preheat oven to 350°. Line a 13x9 baking pan with parchment paper, leaving a generous overhang on all sides. Toast pecans on a rimmed baking sheet, stirring occasionally, until slightly darkened and fragrant, 8–10 minutes. Let cool; chop. Chop 1 pound chocolate and heat with butter in a heatproof bowl set over a saucepan of simmering water (bowl should not touch water), stirring, until butter and chocolate are melted and mixture is smooth. Let cool slightly. Whisk flour, baking powder and salt in a small bowl. Using an electric mixer on medium-high speed, beat eggs, sugar, and vanilla in a large bowl until mixture is pale and thick, 6–8 minutes. Reduce speed to low and add dry ingredients, mixing just to combine. Mix in chocolate mixture. Chop remaining chocolate. Using a wooden spoon or rubber spatula, fold in chopped chocolate and two-thirds of pecans. Scrape batter into prepared baking pan and sprinkle with remaining pecans. Bake brownie until puffed and top is cracked and looks dry and shiny, 30–35 minutes. Let cool before cutting into 2 squares.", details: "You can even make them magical")
...
@herbs_fusilli = Recipe.create(name: "Fusilli di Erbe", instructions: "Heat ¾ cup oil in a large Dutch oven or other heavy pot over medium until shimmering. Add garlic, hardy herbs, fennel pollen (if using), and red pepper flakes and cook, stirring often, until oil around garlic starts to sizzle slightly and garlic begins to turn golden brown, about 2 minutes (be careful when you add the garlic as the oil may spatter). Add spring greens and tender herbs and season with a couple pinches of salt. Cook, stirring often, until greens and herbs are wilted and bright green, about 2 minutes. Scrape herb mixture onto a rimmed baking sheet; spread out and let cool slightly. Reserve pot. Scrape pesto back into reserved pot and add pasta and ¾ cup pasta cooking liquid. Set over medium-low heat and cook, tossing vigorously and adding more pasta cooking liquid if needed, until warmed through and pasta is coated (do not let pesto come to a boil), about 1 minute. Taste and season with more salt if needed.", details: "Delicious pasta!")
...
@noodle_puttanesca = Recipe.create(name: "Noodles", instructions: "Step 1 Pulse beefsteak tomatoes, garlic, red pepper flakes, and 2 tsp. salt in a food processor until smooth; transfer sauce to a large bowl and mix in cherry tomatoes, olives, capers, and ¼ cup oil. Step 2 Cook spaghetti in a large pot of boiling salted water, stirring occasionally, until al dente. Drain pasta, reserving ¼ cup pasta cooking liquid. Step 3 Add pasta, parsley, and butter to sauce. Toss vigorously with tongs, adding a splash of pasta cooking liquid or more as needed to create an emulsified sauce that coats pasta. Divide among bowls and drizzle with more oil.", details: "Delicious pasta")
...
@steaks_and_eggs = Recipe.create(name: "Steak and Eggs", instructions: "Step 1 Mix paprika, Aleppo-style pepper, 2½ tsp. salt, and 1 tsp. black pepper in a bowl. Rub all over steaks, pressing to adhere. Let sit while you make the beans. Step 2 Heat 2 Tbsp. oil in a medium saucepan over medium-low. Cook shallots, garlic, and cilantro stems, stirring often, until softened but not yet browned, about 3 minutes. Add beans, butter, and ¾ cup water. Bring to a simmer and cook, stirring occasionally, until beans are saucy, 6–9 minutes. Remove from heat and stir in cilantro leaves. Finely grate some lime zest from one of the lime halves into beans, then squeeze in its juice. Season with salt and pepper. Cover to keep warm.", details: "Not apt for vegetarians")
